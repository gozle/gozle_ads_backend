# Generated by Django 4.2.5 on 2023-11-04 11:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('hidden', 'Hidden'), ('deleted', 'Deleted'), ('test', 'Test')], default='active', max_length=30)),
                ...
                ('skip_duration', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(3), django.core.validators.MaxValueValidator(15)])),
                ('devices', models.ManyToManyField(to='ads.device', verbose_name='advertisement')),
            ],
            options={
                'verbose_name': 'video',
            },
